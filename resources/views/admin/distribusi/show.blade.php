...
@endswitch
            ...
            <div class="flex justify-center">
                <a href="{{ route('admin.distribusi.index') }}" class="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-700 transition duration-300 shadow-md">
