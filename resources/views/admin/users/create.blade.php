        ...
        <div class="bg-white shadow-2xl rounded-3xl overflow-hidden transform transition-all duration-300 hover:shadow-3xl">
            ...
            <div class="bg-gradient-to-r from-emerald-600 via-teal-500 to-cyan-600 px-8 py-6 relative overflow-hidden">
                ...
                <div class="relative z-10">
                    <h1 class="text-3xl font-bold text-white tracking-tight">Tambah User</h1>
                    <p class="text-emerald-100 mt-2 text-lg">Buat akun pengguna baru dengan informasi lengkap</p>
                </div>
                <!-- Decorative Elements -->
            ...
            <!-- Form Section -->
            <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 space-y-8" x-data="{ role: '{{ old('role') }}' }">
                @csrf
                ...
                {{-- Password --}}
                <div class="space-y-3">
                    <label for="password" class="block text-sm font-semibold text-gray-800 tracking-wide">Password</label>
                    <div class="relative group">
                ...
                <template x-if="role === 'admin'">
                    <div class="mt-10 space-y-8 border-t border-gray-200 pt-8 animate-fade-in">
                        ...
                        <div class="space-y-3">
                            ...
                            <input type="text" id="wilayah_tugas" name="wilayah_tugas" value="{{ old('wilayah_tugas') }}"
